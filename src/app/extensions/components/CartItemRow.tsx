import { Button, Flex, Heading, TableCell, TableRow } from "@hubspot/ui-extensions";
      ...
      <TableCell>
        <Flex direction="column" gap="sm">
          ...
          <Flex gap="xs">
            ...
            {item.toppings && item.toppings.length > 0 && <Addons label="Toppings">{item.toppings.join(", ")}</Addons>}
            {item.premiums && item.premiums.length > 0 && <Addons label="Premiums">{item.premiums.join(", ")}</Addons>}
